...
public class ClassInfo
{
     ...
     * @throws ClassNotFoundException  if the given className is not known.
     */
    ...
    public String toString()
    {
        ...
        sb.append(c.getName()).append(": ").append(pkg.getImplementationTitle()).append(" ").append(pkg.getImplementationVersion()).append(" <").append(pkg.getImplementationVendor()).append("> (").append(getLocation()).append(")");
        return sb.toString();
    }
}
