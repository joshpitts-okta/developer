...
public class StatusHandler implements ISVNStatusHandler, ISVNEventHandler
{
    ...
    {
        /*
         * Gets the status of file/directory/symbolic link text contents. It
         * is SVNStatusType who contains information on the state of an
         * item.
         */
        ...
        {
            /*
             * The item is unversioned, but is used by an eXternals
             * definition.
             */
            pathChangeType = "X";
        ...
        {
            /*
             * The item is in the repository as one kind of object, but
             * what's actually in the user's working copy is some other
             * kind.
             */
            pathChangeType = "~";
        } else if (contentsStatus == SVNStatusType.STATUS_REPLACED)
        {
             ...
             * the item was deleted, and a new item with the same name was
             * added (within a single revision).
             */
            pathChangeType = "R";
         ...
         * following code finds out whether the current item has been
        ...
        /*
         * Whether the item was locked in the .svn working area (for
         * example, during a commit or maybe the previous operation was
         * interrupted, in this case the lock needs to be cleaned up).
         */
        ...
        if (localLock != null)
        {
            ...
            {
                /*
                 * if the lock-token of the local lock differs from the
                 * lock- token of the remote lock - the lock was sTolen!
                 */
        ...
        /*
         * Obtains the number of the revision when the item was last
         * changed.
         */
    ...
    public void handleEvent(SVNEvent event, double progress)
    {
         ...
         * invoked with the flag remote set to true - that is for a local
         * status it won't be dispatched.
         */
