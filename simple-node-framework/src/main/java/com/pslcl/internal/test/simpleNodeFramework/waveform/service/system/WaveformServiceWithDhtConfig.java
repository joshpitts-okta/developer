...
import com.pslcl.internal.test.simpleNodeFramework.config.service.DHTServiceConfig;
 ...
 */
public interface WaveformServiceWithDhtConfig<T> extends EmitConfig<T>, ExecutorConfig<T>, EmitStatusConfig<T>, EmitDataAccessorConfig<T>, DHTServiceConfig<T>
{
}
